(function(){
 ...
 function render(ctxId){
  ...
  document.getElementById('worldSelect').onchange=e=>window.AtlasRouter?.navigate?window.AtlasRouter.navigate('/contexto/'+e.target.value):render(e.target.value);
  document.querySelectorAll('[data-world-era]').forEach(b=>b.onclick=()=>window.AtlasRouter?.navigate?window.AtlasRouter.navigate('/contexto/'+b.dataset.worldEra):render(b.dataset.worldEra));
