...
(function(){
 ...
 function render(report){
  ...
  const hardIssues=[...report.duplicates,...report.postdoctoral.missing,...report.argentina.missing,...report.structural.incomplete,...report.schema.invalidRelations,...report.schema.duplicateRelationIds,...report.schema.worksWithoutProblems];
 ...
 function run(){
  ...
  report.ok=duplicates.length===0&&post.missing.length===0&&report.argentina.ok&&report.structural.ok&&schema.ok;
