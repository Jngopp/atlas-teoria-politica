...
const CORE=['./','index.html','styles.css','systems.css','systems-teaching.css','learning-flow.css','systems-dense.css','curriculum.js','app.js','app-loader.js','genealogies.js','enrichment.js','systems-data.js','systems-engine.js','systems-teaching-data.js','systems-discovery-data.js','systems-v7-plato.js','systems-v7-hobbes.js','systems-v7-marx.js','systems-v7-finalize.js','systems-teaching-loader.js','systems-dense-ui.js','systems-dense-practice.js','settings.js','manifest.webmanifest','icon.svg','../data.js','../world-context-data.js'];
